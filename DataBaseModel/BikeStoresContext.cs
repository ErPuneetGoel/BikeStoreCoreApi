...
namespace FirstCoreApi
{
    public partial class BikeStoresContext : DbContext
    {
        ...
        //        optionsBuilder.UseSqlServer("Data Source=PUNEETGOEL;Initial Catalog=BikeStores;Integrated Security=SSPI;");
        //    }
        //}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D4B7AFB8AB");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164F092E0EF")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D3312E9FB8");
